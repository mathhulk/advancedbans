			...
			<div class="jumbotron">
				...
				<p>
					...
					foreach($types as $type) { //Loop through the types of punishments.
						...
						echo '<a href="'.$url.'" class="btn btn-primary btn-md">'.ucwords(str_replace('_','-',$type)).($type != "all" ? "s" : "").' <span class="badge">'.$rows.'</span></a>'; //Print the resulting punishment type on the page.
					}
					?>
				</p>
			</div>
