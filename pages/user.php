			...
			<div class="jumbotron">
				<div class="row">
					<div class="col-md-4 col-sm-12 text-center">
						...
						<?php
						if($info["skulls"] == true) {
							echo "<img class=\"img-async\" data-src-async=\"".str_replace("{UUID}", ($_GET["user"]), $__global["api"]["body"])."\" alt=\"".htmlspecialchars($_GET["user"])."\"></img>";
						}
						?>
					</div>
